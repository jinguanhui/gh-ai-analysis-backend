...
public class EncryptionUtils {
    ...
    // AES加密配置
    private static final String AES_ALGORITHM = "AES/ECB/PKCS7Padding";  // 使用CBC模式和PKCS7填充
     ...
     * @throws Exception 解密过程中可能出现的异常
     */
    public static String decryptWithAES(String encryptedData, SecretKey secretKey) throws Exception {
        byte[] encryptedBytes = Base64.getDecoder().decode(encryptedData);
        Cipher cipher = Cipher.getInstance(AES_ALGORITHM, "BC");
